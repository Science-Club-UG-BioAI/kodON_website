    ...
    <div className="relative w-full bg-lazuli-400 overflow-hidden">
      ...
      >
        ...
        <div className="font-medium px-4 text-xl mt-10 bg-gradient-to-r from-lazuli-900 to-lazuli-800 text-transparent bg-clip-text inline-block">
          ...
          <br />
          <p>
            W tej chwili pracujemy nad aplikacją wykrywającą skłądniki krwi na
            podstawie zdjęcia spod mikrotkopu oraz planujemy tworzyć użyteczne
            narzędzia bioinformatyczne. To dopiero początek, ale wierzymy, że
            przed nami jeszcze wiele ambitnych projektów i naukowych przygód.
          </p>
        </div>
      </div>
    </div>
