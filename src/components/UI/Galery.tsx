  ...
  return (
    <div className="relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="z-1 absolute w-full h-full flex flex-col justify-center pl-150 pr-30 overflow-hidden bg-gradient-to-r from-lazuli-t to-lazuli-900 to-40% text-lazuli-200">
