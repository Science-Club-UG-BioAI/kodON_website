...
import githubIcon from '/img/gh.png';
...
export default function Footer() {
  ...
  return (
    <footer>
      <div className='relative overflow-hidden bg-gradient-to-r from-lazuli-900 to-lazuli-800'>
        <div className="absolute overflow-hidden inset-0 bg-[url('/codebcg.png')] bg-cover bg-no-repeat bg-center opacity-100 blur-xs" />
        ...
        <div className='relative z-20'>
          <div className="bg-[url('/img/wave.png')] bg-no-repeat bg-cover h-96 md:h-72 2xl:h-96 3xl:h-200 w-full">
